                        ...
                        <td>
                            <div class="cell w-50 mt-5 mb-5 ms-5 me-5 left">
                                ...
                                <div class="cell">
                                    ...
                                    <label class="free-board-nickname" style="font-size:0.8em;">${boardDto.boardWriter}</label>
                                    <i class="fa-solid fa-eye"></i>
                                    <label class="free-board-view" style="font-size:0.8em;">${boardDto.boardView}</label>
                                    <i class="fa-solid fa-comment-dots"></i>
                                    <label class="free-board-reply" style="font-size:0.8em;">${boardDto.boardReply}</label>
                                    <i class="fa-solid fa-heart red"></i>
                                    <label class="free-board-like" style="font-size:0.8em;">${boardDto.boardLike}</label>
                                    <label class="free-board-time" style="font-size:0.8em;">${boardDto.boardWtime}</label>
                                </div>
                            </div>
                        </td>
