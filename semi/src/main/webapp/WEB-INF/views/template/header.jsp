...
.kh-brand__logoImg{ max-width:70px; max-height:70px; object-fit:contain;}
.kh-brand__title{
  margin-top:10px;
  font-weight:700;
  color:var(--text);
...
.kh-pill:hover{ filter:brightness(0.95); transform:translateY(-1px); }


@media (max-width:960px){
  .kh-header__wrap{ gap:16px; padding:12px 16px; }
  .kh-brand{ width:120px; }
  .kh-pill{ padding:7px 14px; }
}
.kh-top {
  flex: 1;
  display: flex;
  ...
  <div class="kh-header__wrap">
    <div class="kh-top">
      ...
      <div class="kh-brand__logoCard">
        <img src="${cp}/image/petCafe.png" alt="KH PETIQUE" class="kh-brand__logoImg">
      </div>	
