...
<c:if
	test="${pageContext.request.requestURI != '/WEB-INF/views/member/join.jsp'}">
	<div class="cell flex-box flex-vertical w-25p ms-20">
		<div class="cell ms-10 me-10 center">
			<c:choose>
				<c:when
					test="${sessionScope.loginId != null && sessionScope.loginLevel == '0' }">
					<div class="cell">
						<div class="flex-box">
							<img src="/member/profile?member_id=${sessionScope.loginId }"
								width="50" height="50">
				...
				<c:when
					test="${sessionScope.loginId != null && sessionScope.loginLevel >= '1' }">
					<div class="cell">
						<div class="flex-box">
							<img src="/member/profile?member_id=${sessionScope.loginId }"
								width="50" height="50">
				...
				<c:otherwise>
					<form id="login-form">
						<div class="cell">
							<label>아이디</label> <input class="field w-100p" type="text"
								name="memberId">
							<div class="fail-feedback"></div>
						</div>
						<div class="cell">
							<label>비밀번호</label> <input class="field w-100p" type="password"
								name="memberPw">
							<div class="fail-feedback"></div>
						</div>
						...
						<hr>
						<div class="cell center">
							<a href="/member/findId" class="link gray">아이디 찾기</a> <span
								class="gray">|</span> <a href="/member/findPw" class="link gray">비밀번호
								찾기</a> <span class="gray">|</span> <a class="link gray"
