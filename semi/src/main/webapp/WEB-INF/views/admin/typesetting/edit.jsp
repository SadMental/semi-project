...
<div class="container w-800">
    <h1>타입 헤더 수정</h1>
    <form action="${pageContext.request.contextPath}/admin/typesetting/edit" method="post">
        <input type="hidden" name="typeHeaderNo" value="${typeHeaderDto.typeHeaderNo}">
        <label for="typeHeaderName">타입 헤더 이름</label>
        <input type="text" id="typeHeaderName" name="typeHeaderName" value="${typeHeaderDto.typeHeaderName}" required>
