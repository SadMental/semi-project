...
/* detail.jsp의 <style> 블록 또는 외부 CSS 파일에 추가 */
.container .content {
   min-height: 250px; /* 본문 내용이 보이도록 최소 높이 설정 */
   padding: 15px;
   border: 1px solid #d3bfa6; /* 영역 확인을 위한 경계선 */
}
.btn-neutral {
...
<c:if test="${not empty headerDto}">
	...
	<div class="content" style="min-height: 200px; padding: 20px; border: 1px solid #e0e0e0;">
