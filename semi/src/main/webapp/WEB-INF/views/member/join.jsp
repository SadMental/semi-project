...
<script src="/summernote/custom-summernote.js"></script>
    ...
    <form action="join" method="post" enctype="multipart/form-data" autocomplete="off">
        <div class="container w-600">
            ...
            <div class="cell">
                <span class="id-feedback" style="color: red;">* 아이디: 1~20자의 영문 대/소문자, 숫자만 사용 가능합니다.</span>
            ...
            <div class="cell">
                ...
                <span class="pw2-feedback" style="color: red;">* 비밀번호: 8~20자의 영문 대/소문자, 숫자, 특수문자(!@#$)를 사용해 주세요.</span>
            </div>
            <br>
            <div class="cell">
                <label>
